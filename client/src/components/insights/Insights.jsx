  ...
  return (
    ...
    >
      <div className="w-full relative">
        <div className="w-full h-1/2 bg-primaryColor absolute top-0 z-0"></div>
        <div className="relative bg-gray-950 mb-10 py-5 lg:py-10 px-3 mx-3 sm:mx-5 md:mx-10 lg:mx-20 rounded-2xl sm:px-5 md:px-10 lg:px-20 font-bodyFont text-bodyColor shadow-xl shadow-gray-600 z-10">
        ...
        <div className="w-full h-1/2 bg-titleColor absolute bottom-0 z-0"></div>
      </div>
